...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("karolinaszymanska899@gmail.com");
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                The aspiring Frontend Developer with a focus on self-development
                by acquiring new tech skills.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                The technologies I know as well as the ones I am going to
                acquire.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="md:text-xl font-medium text-gray_gradient text-white">
                  karolinaszymanska899@gmail.com
                </p>
              </div>
            </div>
          </div>
